...
"use strict";
const Ajv = __webpack_require__(4);
const ajv = new Ajv();
...
module.exports = {
  "shield-study": __webpack_require__(7), // eslint-disable-line max-len
  "shield-study-addon": __webpack_require__(5), // eslint-disable-line max-len
  "shield-study-error": __webpack_require__(6), // eslint-disable-line max-len
  studySetup: __webpack_require__(12),
  weightedVariations: __webpack_require__(13),
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schemas__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schemas___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__schemas__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jsonschema__ = __webpack_require__(0);
/* eslint-env commonjs */
...
const UTILS_VERSION = __webpack_require__(9).version;
...
class StudyUtils {
  ...
  constructor() {
    ...
    */
    ...
    // expose schemas
    this.schemas = __WEBPACK_IMPORTED_MODULE_1__schemas___default.a;
  ...
  setup(studySetup) {
    ...
    __WEBPACK_IMPORTED_MODULE_2__jsonschema__["a" /* default */].validateOrThrow(studySetup, __WEBPACK_IMPORTED_MODULE_1__schemas___default.a.studySetup);
  ...
  async _telemetry(data, bucket = "shield-study-addon") {
    ...
    /* istanbul ignore next */
    try {
      validation = __WEBPACK_IMPORTED_MODULE_2__jsonschema__["a" /* default */].validate(payload, __WEBPACK_IMPORTED_MODULE_1__schemas___default.a[bucket]);
    } catch (err) {
...
this.study = class extends ExtensionAPI {
  ...
  getAPI(context) {
    const { studyUtils } = __webpack_require__(2);
    const studyUtilsBootstrap = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jsonschema__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schemas__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schemas___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__schemas__);
...
function chooseWeighted(weightedVariations, fraction = Math.random()) {
  ...
  */
  __WEBPACK_IMPORTED_MODULE_0__jsonschema__["a" /* default */].validateOrThrow(weightedVariations, __WEBPACK_IMPORTED_MODULE_1__schemas___default.a.weightedVariations);
